...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlayerControllerShooter_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APlayerControllerShooter_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_APlayerControllerShooter()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_APlayerControllerShooter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(APlayerControllerShooter, 2148974838);
	template<> SHOOTER_API UClass* StaticClass<APlayerControllerShooter>()
	{
		return APlayerControllerShooter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APlayerControllerShooter(Z_Construct_UClass_APlayerControllerShooter, &APlayerControllerShooter::StaticClass, TEXT("/Script/Shooter"), TEXT("APlayerControllerShooter"), false, nullptr, nullptr, nullptr);
