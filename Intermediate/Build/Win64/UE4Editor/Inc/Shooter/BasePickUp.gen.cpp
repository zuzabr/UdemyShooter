...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABasePickUp_Statics::NewProp_CollisionComponent_MetaData[] = {
		{ "Category", "PickupInfo" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABasePickUp_Statics::NewProp_CollisionComponent = { "CollisionComponent", nullptr, (EPropertyFlags)0x00200800000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABasePickUp, CollisionComponent), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABasePickUp_Statics::NewProp_CollisionComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABasePickUp_Statics::NewProp_CollisionComponent_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABasePickUp_Statics::NewProp_RespawnTime_MetaData[] = {
		{ "Category", "PickupInfo" },
		{ "ModuleRelativePath", "Public/PickUps/BasePickUp.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABasePickUp_Statics::NewProp_RespawnTime = { "RespawnTime", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABasePickUp, RespawnTime), METADATA_PARAMS(Z_Construct_UClass_ABasePickUp_Statics::NewProp_RespawnTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABasePickUp_Statics::NewProp_RespawnTime_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABasePickUp_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABasePickUp_Statics::NewProp_CollisionComponent,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABasePickUp_Statics::NewProp_RespawnTime,
	};
	...
	IMPLEMENT_CLASS(ABasePickUp, 2486417254);
	template<> SHOOTER_API UClass* StaticClass<ABasePickUp>()
	{
		return ABasePickUp::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABasePickUp(Z_Construct_UClass_ABasePickUp, &ABasePickUp::StaticClass, TEXT("/Script/Shooter"), TEXT("ABasePickUp"), false, nullptr, nullptr, nullptr);
